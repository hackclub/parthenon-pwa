...
const Goddess1 = new Goddess("Ma'at", "Egyptian goddess of truth, justice, and cosmic balance, symbolized by the feather of order.", "/gods/maat.jpg", "#6E7B58") // Olive-green wisdom
const Goddess2 = new Goddess("Kannon", "Japanese bodhisattva of compassion, offering mercy and serenity to all beings.", "/gods/kannon.jpg", "#567A86") // Muted teal
const Goddess3 = new Goddess("Parvati", "Hindu goddess of love and devotion, embodying nurturing strength.", "/gods/pavarti.webp", "#7E5F4E") // Warm earthy brown
const Goddess4 = new Goddess("Minerva", "Roman goddess of wisdom and strategy, protector of heroes and scholars.", "/gods/minerva.webp", "#7A8350") // Sage green
...
const Goddess7 = new Goddess("Bellona", "Roman goddess of war, embodying valor and fierce determination.", "/gods/bellona.jpg", "#8E4042") // Deep crimson
